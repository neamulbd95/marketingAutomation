...
function initSettingsTab() {
  ...
  $('.settings-nav-item').on('click', function () {
    ...
    $('.settings-section').addClass('d-none').removeClass('active');
    $('#settings-' + section).removeClass('d-none').addClass('active');
  });
  ...
  $('#logo-upload-area').on('click', () => $('#s-logo-file').trigger('click'));
